...
export class CultureGuardianService {
  readonly rules = signal<CultureRule[]>([
    {
      ...
      penaltyPoints: 35,
      description: 'Prohibits incomplete code generated by AI agents, including TODOs, FIXMEs, empty pass statements, or stubs without a functional body.',
    ...
    },
    {
      ...
      rationale: 'No AI-generated code may be integrated into the codebase without automated tests validating its correctness.',
    ...
    },
    {
      ...
      severity: 'P0_BLOCKING',
      penaltyPoints: 40,
      description: 'Detection of credentials, API keys, passwords, or sensitive tokens hardcoded in generated code.',
    ...
    },
    {
      ...
      severity: 'P1_WARNING',
      penaltyPoints: 10,
      description: 'Requires strict typing on parameters and return types of generated functions.',
      rationale: 'Prevents ambiguity and runtime errors arising from type hallucinations.',
  ...
  readonly history = signal<AnalysisRun[]>([
    ...
    },
    {
      ...
      mrTitle: 'Fix lexer and add AI stub',
...
`,
    ...
    },
    {
      ...
      mrId: '87',
      mrTitle: '#87 — Update payment gateway with AI',
      targetBranch: 'main',
...
`,
  ...
  auditCode(fileName: string, code: string, hasTestFile: boolean, author: string = 'AI Agent'): FileAuditInfo {
